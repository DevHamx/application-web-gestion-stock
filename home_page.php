...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-primary fixed-top">
      <a class="navbar-brand" href="Home_page.html">Accueil</a>
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item" href="#">Rechercher une Catégorie</a>
              <a class="dropdown-item" href="#">Afficher la liste des Catégories</a>
            </div>
          </li>
          <li class="nav-item dropdown active">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown03">
              ...
              <a class="dropdown-item" href="#">Rechercher un article</a>
            </div>
          </li>
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown04">
              <a class="dropdown-item" href="#">effectue un achat</a>
              <a class="dropdown-item" href="#">consultation des achats</a>
            </div>
          </li>
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown04">
              <a class="dropdown-item" href="#">Prendre un produit</a>
              <a class="dropdown-item" href="#">consultation des collectibles</a>
            </div>
          </li>
        </ul>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
        ...
        <h1 style="color:#0a8ab4;" class="mb-3 font-weight-bold text-uppercase">Gestion de stock</h1>
