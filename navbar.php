    ...
    <div class="collapse navbar-collapse" id="navbarColor02">
      <ul class="navbar-nav mr-auto">
        <?php
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              <?php if ($profile[0] == 1||$profile[0] == 3){?><a class="dropdown-item" href="ajoutement_categorie1.php">Ajouter une Catégorie</a><?php}?>
        ...
        <li class="nav-item dropdown active">
          ...
          <?php if ($profile[0] == 1||$profile[0] == 3){?><a class="dropdown-item" href="ajoutement_categorie2.php">Ajouter une Catégorie</a><?php}?>
        ...
        <li class="nav-item dropdown active">
          ...
          <?php if ($profile[0] == 1||$profile[0] == 3){?><a class="dropdown-item" href="ajoutement_articles.php">Ajouter un article</a><?php}?>
