        ...
        if (isset($_POST["valeur"])==false) {
            ...
            if (isset($_POST["valeur"])&&isset($_POST["method"])) {
                ...
                if ($_POST["method"] == "ID de la catégorie") {
                    $reponse=mysqli_query($con,"select * from categore2 where ID_CATEGORE2 = $valeur");
                ...
                elseif ($_POST["method"] == "Afficher toute la list") {
                    ...
                    $reponse2=mysqli_query($con,"select * from categore2 where NOM_CATEGORE2 like '%$valeur%'");
